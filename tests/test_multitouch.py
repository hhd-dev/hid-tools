...
class Digitizer(base.UHIDTestDevice):
    ...
    def __init__(self, name, rdesc_str=None, rdesc=None, application='Touch Screen', physical='Finger', max_contacts=None, input_info=(BusType.USB, 1, 2), quirks=None):
...
class TestSmart_0b8c_0092(BaseTest.TestMultitouch):
    def create_device(self):
        return SmartTechDigitizer('uhid test smart_0b8c_0092',
                                  input_info=(BusType.USB, 0x0b8c, 0x0092))
...
class Testelan_04f3_313a(BaseTest.TestPTP):
    def create_device(self):
        return PTP('uhid test elan_04f3_313a',
                   type='touchpad',
...
class Testsynaptics_06cb_ce08(BaseTest.TestPTP):
    def create_device(self):
        return PTP('uhid test synaptics_06cb_ce08',
                   max_contacts=5,
